...
import com.app.goldenhealth.ui.fragment.CauHoiMotLuaChonView;
...
public class CauHoiMotLuaChonPresenterImpl extends BasePresenterImpl<CauHoiMotLuaChonView> implements CauHoiMotLuaChonPresenter {

    private static final String TAG = "CauHoiMotLuaChon" ;

    public CauHoiMotLuaChonPresenterImpl(CauHoiMotLuaChonView view) {
        super(view);
    }
